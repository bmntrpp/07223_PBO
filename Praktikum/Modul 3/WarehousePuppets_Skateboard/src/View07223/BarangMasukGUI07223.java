    ...
    public BarangMasukGUI07223() {
        ...
        create.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    allobjctrl07223.barangMasukModel.insertBarang(new BarangMasukEntity07223(kode,jenis,harga,tanggal,gudang));
        ...
        update.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                Date tanggal = new Date(ttanggal.getText());
                String gudang = tgudang.getText();
                allobjctrl07223.barangMasukModel.updateBarang(index, new BarangMasukEntity07223(kode,jenis,harga,tanggal,gudang));
