...
public class Main_07223 {
    ...
    static void BarangMasuk() {
        ...
        datamasuk.insertBarang(new BarangMasukEntity07223(kode, jenis, harga,tanggal,gudang));
    }
     static void BarangKeluar() {
        ...
        datakeluar.insert(new BarangKeluarEntity07223(kode, jenis, harga,tanggal, kota));
    } 
    ...
    static void UpdateBarangMasuk(){
        ...
        System.out.print("Gudang = ");
        String gudang = input.next();
        datamasuk.update(index, new BarangMasukEntity07223(kode, jenis, harga,tanggal,gudang)); 
    }
    ...
    static void UpdateBarangKeluar(){
        ...
        System.out.print("Kota = ");
        String kota = input.next();
        datakeluar.update(index, new BarangKeluarEntity07223(kode, jenis, harga,tanggal,kota)); 
    }
