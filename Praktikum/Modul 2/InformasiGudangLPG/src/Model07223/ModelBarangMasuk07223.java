...
import Entity07223.BarangMasuk07223;
import java.text.SimpleDateFormat;
import java.util.ArrayList;
import java.util.Date;

public class ModelBarangMasuk07223 implements Interfaces07223 {
    private ArrayList<BarangMasuk07223> BarangMasuk07223ArrayList;

    public ModelBarangMasuk07223() {
        BarangMasuk07223ArrayList = new ArrayList<BarangMasuk07223>();
    }
    ...
    public void insertBarang(BarangMasuk07223 Barang ) {
        BarangMasuk07223ArrayList.add(Barang);
    }
    
    public void update(int index, BarangMasuk07223 barangMasuk07223) {
        BarangMasuk07223ArrayList.set(index,(BarangMasuk07223) barangMasuk07223);
    }
    ...
    public void view() {
        if(BarangMasuk07223ArrayList.isEmpty()) {
            ...
            int i=0;
            for (BarangMasuk07223 barangmasuk07223 : BarangMasuk07223ArrayList) {
                System.out.println("\nData Barang Ke "+i);
                System.out.println("===============================================================");
    ...
    public BarangMasuk07223 showDataBarang(int index){
