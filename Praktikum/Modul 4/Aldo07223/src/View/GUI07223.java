    ...
    public GUI07223() {
        ...
        check.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (ceklogin == true) {
                    try {
                        allobjctrl07223.admin.dataAslab();
                        allobjctrl07223.admin.login(textnpmlogin.getText(), passwordlogin.getText());
                        String nama = allobjctrl07223.admin.aslabEntity().getNama();
                        JOptionPane.showMessageDialog(null, "Selamat Datang " + nama, "information", JOptionPane.INFORMATION_MESSAGE);
                        AslabGUI07223 asisten = new AslabGUI07223();
                        LogReg.dispose();
                    ...
                    try {
                        allobjctrl07223.praktikan.login(textnpmlogin.getText(), passwordlogin.getText());
                        String nama = allobjctrl07223.praktikan.praktikanEntity().getNama();
                        JOptionPane.showMessageDialog(null, "Selamat Datang " + nama, "information", JOptionPane.INFORMATION_MESSAGE);
                        PraktikanGUI07223 prak = new PraktikanGUI07223();
                        LogReg.dispose();
                    } catch (Exception exception) {
                        JOptionPane.showMessageDialog(null, "NPM atau Password Salah", "information", JOptionPane.INFORMATION_MESSAGE);
                        kosong();
        ...
        reg.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    allobjctrl07223.praktikan.insert(npm, pass, nama, notelp, tgllahir, kelas);
