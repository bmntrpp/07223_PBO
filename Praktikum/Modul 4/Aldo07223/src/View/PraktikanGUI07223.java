...
public class PraktikanGUI07223 {

    JFrame Praktikan = new JFrame();
    JButton back, daftarbtn;
    JTextArea area = new JTextArea();
    JLabel datadiri, daftarpraktikum;
    JComboBox pilprak = new JComboBox(PraktikumEntity07223.nama);
    int cek = allobjctrl07223.praktikan.cekDaftarprak(allobjctrl07223.praktikan.praktikanEntity().getNpm());

    public PraktikanGUI07223() {
        ...
        daftarbtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                allobjctrl07223.praktikan.daftarPraktikum(indexprak, allobjctrl07223.praktikan.getData(), false);
                area.setText(datapraktikan());
            }
        });
    ...
    String datapraktikan() {
        int cek = allobjctrl07223.praktikan.cekDaftarprak(allobjctrl07223.praktikan.praktikanEntity().getNpm());
        String cekverif;
        if (allobjctrl07223.praktikan.showDaftarprak(cek).isVerified() == false) {
            cekverif = "belum diverifikasi";
        } else {
            cekverif = "sudah diverifikasi";
        }
        String text
                = "Npm = " + allobjctrl07223.praktikan.showDaftarprak(cek).getPraktikan().getNpm() + "\n"
                + "Nama = " + allobjctrl07223.praktikan.showDaftarprak(cek).getPraktikan().getNama() + "\n"
                + "No Telp = " + allobjctrl07223.praktikan.showDaftarprak(cek).getPraktikan().getNo_telp() + "\n"
                + "Tanggal Lahir = " + new SimpleDateFormat("dd-MM-yyyy")
                .format(allobjctrl07223.praktikan.showDaftarprak(cek).getPraktikan().getTgllahir()) + "\n"
                + "verifikasi = " + cekverif + "\n"
                + "Kelas = " + allobjctrl07223.praktikan.showDaftarprak(cek).getPraktikan().getKelas() + "\n"
                + "Praktikum = " + PraktikumEntity07223.nama[allobjctrl07223.praktikan.showDaftarprak(cek).getIndexPrak()];
