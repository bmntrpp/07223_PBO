    ...
    public BarangKeluarGUI07223() {
        ...
        create.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    allobjctrl07223.barangKeluarModel.insertBarang(kode,jenis,harga,tanggal,kota);
        ...
        update.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                Date tanggal = new Date(ttanggal.getText());
                String kota = tkota.getText();
                allobjctrl07223.barangKeluarModel.updateBarang(index,kode,jenis,harga,tanggal,kota);
